...
test('invoices are filtered by fiscal_year in queries', function () {
    ...
    FiscalDocument::create(['number' => 'FT-2023', 'date' => '2023-01-10', 'contact_id' => $contact->id]);
    FiscalDocument::create(['number' => 'FT-2024', 'date' => '2024-05-20', 'contact_id' => $contact->id]);
    FiscalDocument::create(['number' => 'FT-2025', 'date' => '2025-03-01', 'contact_id' => $contact->id]);

    $invoices2024 = FiscalDocument::where('fiscal_year', 2024)->get();
