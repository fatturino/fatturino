...
test('getNextNumber returns correct next number', function () {
    ...
    FiscalDocument::create(['number' => 2, 'sequential_number' => 2, 'date' => now(), 'contact_id' => $contact->id, 'sequence_id' => $sequence->id]);
...
test('getNextNumber handles gaps in invoice numbering', function () {
    ...
    foreach ([1, 3, 7] as $number) {
        FiscalDocument::create(['number' => $number, 'sequential_number' => $number, 'date' => now(), 'contact_id' => $contact->id, 'sequence_id' => $sequence->id]);
    }
...
test('getFormattedNumber increments correctly', function () {
    ...
    for ($i = 2; $i <= 9; $i++) {
        FiscalDocument::create(['number' => $i, 'sequential_number' => $i, 'date' => now(), 'contact_id' => $contact->id, 'sequence_id' => $sequence->id]);
    }
...
test('multiple sequences maintain separate numbering', function () {
    ...
    FiscalDocument::create(['number' => 1, 'sequential_number' => 1, 'date' => now(), 'contact_id' => $contact->id, 'sequence_id' => $seq1->id]);
    FiscalDocument::create(['number' => 2, 'sequential_number' => 2, 'date' => now(), 'contact_id' => $contact->id, 'sequence_id' => $seq1->id]);
    FiscalDocument::create(['number' => 1, 'sequential_number' => 1, 'date' => now(), 'contact_id' => $contact->id, 'sequence_id' => $seq2->id]);
...
test('getNextNumber resets to 1 for a new year', function () {
    ...
    FiscalDocument::create(['number' => 1, 'sequential_number' => 1, 'date' => '2025-06-15', 'contact_id' => $contact->id, 'sequence_id' => $sequence->id]);
    FiscalDocument::create(['number' => 2, 'sequential_number' => 2, 'date' => '2025-11-20', 'contact_id' => $contact->id, 'sequence_id' => $sequence->id]);
    ...
    FiscalDocument::create(['number' => 1, 'sequential_number' => 1, 'date' => '2026-01-10', 'contact_id' => $contact->id, 'sequence_id' => $sequence->id]);
