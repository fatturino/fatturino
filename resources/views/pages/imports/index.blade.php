...
<section class="max-w-4xl space-y-6">
    ...
    <form wire:submit="import" class="rounded-xl border border-border-light bg-white p-5 shadow-[var(--shadow-card)]"><div class="grid gap-4 md:grid-cols-2">@php
...
@endphp
<x-select label="Tipo import" wire:model.live="importType" :options="$importTypeOptions" /><div class="rounded-md bg-surface-muted p-3 text-sm text-content-muted">@if($importType === 'fattura24_contacts')Carica l'esportazione CSV da Fattura24.@else Carica uno o più file XML, P7M o ZIP, fino a 10 MB ciascuno.@endif</div></div>
