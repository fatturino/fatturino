...
<x-slot:header><div><p class="text-xs font-medium text-content-muted">Anagrafiche</p><h1 class="text-lg font-semibold text-content">Nuovo contatto</h1></div></x-slot:header>

<x-contacts.form submit-label="Crea contatto" />
