...
<section class="space-y-6">
    <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between"><div><p class="text-xs font-bold uppercase tracking-[.12em] text-content-muted">Rubrica</p><p class="mt-1 text-sm text-content-muted">Gestisci clienti e fornitori.</p></div><x-app-link :href="route('contacts.create')" class="rounded-md bg-primary px-4 py-2 text-sm font-bold text-white">Nuovo contatto</x-app-link></div>
