...
<body class="min-h-screen font-sans antialiased bg-base-100">
    <div class="min-h-screen flex items-center justify-center px-6">
        <div class="text-center max-w-md">
            ...
            {{-- Receipt icon with error accent --}}
            <div class="inline-flex items-center justify-center mb-8">
                <svg class="w-20 h-24" viewBox="0 0 28 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M2 3C2 1.34 3.34 0 5 0H23C24.66 0 26 1.34 26 3V29L23 27L20 29L17 27L14 29L11 27L8 29L5 27L2 29V3Z"
                          class="fill-base-300"/>
                    {{-- "!" warning mark --}}
                    <text x="14" y="20" text-anchor="middle" class="fill-error" font-size="16" font-weight="800" font-family="Outfit, sans-serif">!</text>
                </svg>
            </div>

            {{-- Error code --}}
            <h1 class="text-7xl font-extrabold tracking-tight text-error mb-2">500</h1>
            ...
            <div class="flex flex-wrap justify-center gap-3">
                ...
                <a href="javascript:location.reload()" class="inline-flex items-center justify-center font-medium tracking-wide transition-colors duration-200 rounded-md px-4 py-2 text-sm gap-2 border border-base-300 text-base-content/70 bg-transparent hover:bg-base-200">
                    {{ __('app.errors.retry') }}
                </a>
            </div>
