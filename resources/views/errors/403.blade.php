            ...
            <div class="inline-flex items-center justify-center mb-8">
                <svg class="w-20 h-24" viewBox="0 0 28 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M2 3C2 1.34 3.34 0 5 0H23C24.66 0 26 1.34 26 3V29L23 27L20 29L17 27L14 29L11 27L8 29L5 27L2 29V3Z"
                          class="fill-base-300"/>
                    {{-- "x" mark to indicate forbidden action --}}
                    <text x="14" y="20" text-anchor="middle" class="fill-warning" font-size="16" font-weight="800" font-family="Outfit, sans-serif">x</text>
                </svg>
            </div>

            <h1 class="text-7xl font-extrabold tracking-tight text-warning mb-2">403</h1>

            <p class="text-lg font-semibold text-base-content mb-2">
                {{ __('app.errors.403_title') }}
            </p>
            <p class="text-base-content/50 mb-10">
                {{ __('app.errors.403_desc') }}
            </p>
