...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .code { font-size: 6rem; font-weight: 800; color: #F7B801; line-height: 1; }
        h1 { margin-top: 1rem; font-size: 1.5rem; font-weight: 700; }
        p { margin-top: 0.75rem; color: #7678ED; max-width: 28rem; text-align: center; }
        .hint { margin-top: 0.5rem; font-size: 0.8125rem; color: #7678ED; }
        button {
        ...
        button:hover { background: #F7B801; }
    </style>
</head>
<body>
    ...
    <div class="icon">
        <svg width="80" height="96" viewBox="0 0 28 34" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <circle cx="14" cy="13" r="7" stroke="#F7B801" stroke-width="1.8" fill="none"/>
            <line x1="14" y1="13" x2="14" y2="9" stroke="#F7B801" stroke-width="1.8" stroke-linecap="round"/>
            <line x1="14" y1="13" x2="17" y2="15" stroke="#F7B801" stroke-width="1.8" stroke-linecap="round"/>
        </svg>
    </div>
