...
<article class="rounded-xl border border-border-light bg-white p-5 shadow-[var(--shadow-card)]">
    <div class="flex items-start justify-between gap-4">
        ...
        <span class="rounded-full bg-surface-muted px-2.5 py-1 text-xs font-medium text-content-muted">{{ count($items) }} priorità</span>
    </div>
    ...
    <div class="mt-4 divide-y divide-border-light">
        ...
        @empty
            <div class="py-6 text-center"><p class="font-medium text-content">Nessuna urgenza per ora</p><p class="mt-1 text-sm text-content-muted">Gli incassi aperti e i documenti da inviare compariranno qui.</p></div>
        @endforelse
