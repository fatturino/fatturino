...
<aside
    ...
    class="fixed inset-y-0 left-0 z-50 flex w-64 -translate-x-full flex-col border-r border-white/8 bg-ink text-white transition-transform duration-300 lg:translate-x-0"
