...
class CreditNoteXmlService
{
    ...
    {
        return $this->buildSdiFilename($this->companySettings, $creditNote->id);
    }
    ...
    public function generate(CreditNote $creditNote): string
    {
        ...
        if ($creditNote->payment_method) {
            ...
            $paymentMethodValue = $creditNote->payment_method instanceof \BackedEnum
                ? $creditNote->payment_method->value
                : $creditNote->payment_method;
