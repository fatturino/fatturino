...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('fiscal_documents', function (Blueprint $table) {
            ...
            $table->foreignId('proforma_id')->nullable()->constrained('fiscal_documents')->nullOnDelete();
            ...
            $table->string('sdi_primary_channel')->nullable();
            ...
            $table->unique(['fiscal_year', 'type', 'number'], 'fiscal_documents_fiscal_year_type_number_unique');
