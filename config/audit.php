...
return [
    ...
    */
    ...
    // Skip audits where both old/new values are empty (prevents noise from
    // parent Invoice recalculation cascades where all changed columns are excluded).
    // Custom lifecycle events are whitelisted since they carry no field diffs.
    'empty_values' => false,
